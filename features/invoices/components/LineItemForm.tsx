...
import type { LineItemActionState } from "../actions";

const initialState: LineItemActionState = {};
...
export function LineItemForm({
  ...
  action: (prevState: LineItemActionState, formData: FormData) => Promise<LineItemActionState>;
